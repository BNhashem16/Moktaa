...
import { BarcodeBlackListComponent, barcodeExists, getBarcodeData } from "./BarcodeBlackListComponent";
function App() {
  ...
  // ];
  const barcodes = BarcodeBlackListComponent();
  ...
  return (
    <div>
      ...
      />
       {qrResult && qrResult !== null ? ( barcodeExists(qrResult) ? (
          errorAlert
        ) : (
